...
const Hex = () => {
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8 h-full flex flex-col-reverse md:flex-row items-center">
        {/* Text Content on the Left */}
        <div className="md:w-1/2 text-left text-gray-300 flex flex-col justify-center">
        ...
        {/* Image on the Right */}
        <div className="md:w-1/2 flex justify-center md:justify-end items-center mt-8 md:mt-0">
          <img
            src={hexImage}
            alt="Hex ID"
