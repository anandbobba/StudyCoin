...
const TransformingLearning = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 py-28 px-4">
      {/* Title Section */}
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 w-full max-w-7xl">
        ...
        <div className="bg-white rounded-lg text-center p-6 flex flex-col items-center shadow-lg">
          ...
          <button 
            className="bg-primary-purple text-white px-6 py-3 rounded-full text-lg hover:bg-purple-800 transition"
