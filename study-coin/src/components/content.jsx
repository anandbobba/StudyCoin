...
const Content = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen relative" style={{ backgroundImage: `url(${blockchainBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl p-8">
        {/* Content Section */}
        <div className="flex-1 text-left pr-0 md:pr-8">
          {/* Main Heading in Yellow */}
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-yellow-500 mb-6">
          ...
          {/* List Items in White */}
          <ul className="text-base sm:text-lg text-white mb-6 list-disc list-inside">
        ...
        <div className="flex-1 flex justify-center md:justify-end mt-8 md:mt-0">
          <img 
            src={studyChainImage} 
            alt="Study Chain" 
            className="w-[300px] h-[280px] sm:w-[400px] sm:h-[380px] md:w-[500px] md:h-[480px] lg:w-[606px] lg:h-[571px] object-contain rounded-lg" 
          />
        </div>
      </div>
      <Study/>
